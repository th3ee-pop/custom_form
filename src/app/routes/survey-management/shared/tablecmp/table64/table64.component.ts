...
export class Table64Component extends Question implements OnInit {
  ...
  ngOnInit() {
      ...
      // this.array0 = this.initialArray.slice(0,3);
      // this.array1[0] = this.initialArray.slice(3,13);
      // this.array1[1] = this.initialArray.slice(13,23);
      // this.array3 = this.initialArray.slice(23,29);
